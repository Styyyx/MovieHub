        ...
        private void loadHomePanel()
        {
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                ...
                using (SqlDataAdapter sqlDA = new SqlDataAdapter(query, conn))
                {
                    ...
                    dataGridView2.Columns["movie_id"].ReadOnly = true;
                    dataGridView2.Columns["name"].ReadOnly = true;
                    dataGridView2.Columns["year"].ReadOnly = true;
                    dataGridView2.Columns["director"].ReadOnly = true;
                    dataGridView2.Columns["producer"].ReadOnly = true;
                    dataGridView2.Columns["cast"].ReadOnly = true;
                    dataGridView2.Columns["length"].ReadOnly = true;
                    dataGridView2.Columns["language"].ReadOnly = true;
                    dataGridView2.Columns["revenue"].ReadOnly = true;
                    dataGridView2.Columns["genre"].ReadOnly = true;
                    dataGridView2.Columns["awards"].ReadOnly = true;
